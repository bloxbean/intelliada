...
public class HeliosDataFieldImpl extends ASTWrapperPsiElement implements HeliosDataField {

  public HeliosDataFieldImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public HeliosNameTypePair getNameTypePair() {
    return findNotNullChildByClass(HeliosNameTypePair.class);
  }
