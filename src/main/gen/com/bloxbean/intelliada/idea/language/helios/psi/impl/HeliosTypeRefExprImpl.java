...
public class HeliosTypeRefExprImpl extends HeliosValueExprImpl implements HeliosTypeRefExpr {

  public HeliosTypeRefExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HeliosVisitor visitor) {
    visitor.visitTypeRefExpr(this);
  }
