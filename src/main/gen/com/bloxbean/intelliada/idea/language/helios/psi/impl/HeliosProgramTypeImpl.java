...
public class HeliosProgramTypeImpl extends ASTWrapperPsiElement implements HeliosProgramType {

  public HeliosProgramTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HeliosVisitor visitor) {
    visitor.visitProgramType(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getProgramTypesCode() {
    return findNotNullChildByType(PROGRAM_TYPES_CODE);
  }
