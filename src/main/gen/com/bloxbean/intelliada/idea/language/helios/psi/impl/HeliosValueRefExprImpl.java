...
public class HeliosValueRefExprImpl extends HeliosValueExprImpl implements HeliosValueRefExpr {

  public HeliosValueRefExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HeliosVisitor visitor) {
    visitor.visitValueRefExpr(this);
  }
