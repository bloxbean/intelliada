...
public class HeliosTypePathExprImpl extends HeliosValueExprImpl implements HeliosTypePathExpr {

  public HeliosTypePathExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HeliosVisitor visitor) {
    visitor.visitTypePathExpr(this);
  }
