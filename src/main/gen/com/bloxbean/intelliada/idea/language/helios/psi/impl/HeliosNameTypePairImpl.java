...
public class HeliosNameTypePairImpl extends ASTWrapperPsiElement implements HeliosNameTypePair {

  public HeliosNameTypePairImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HeliosVisitor visitor) {
    visitor.visitNameTypePair(this);
  }
