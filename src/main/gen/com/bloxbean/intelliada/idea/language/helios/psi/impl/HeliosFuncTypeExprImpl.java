...
public class HeliosFuncTypeExprImpl extends HeliosValueExprImpl implements HeliosFuncTypeExpr {

  public HeliosFuncTypeExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HeliosVisitor visitor) {
    visitor.visitFuncTypeExpr(this);
  }
