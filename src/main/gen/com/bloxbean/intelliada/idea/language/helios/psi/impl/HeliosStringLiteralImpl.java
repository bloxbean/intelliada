...
public class HeliosStringLiteralImpl extends ASTWrapperPsiElement implements HeliosStringLiteral {

  public HeliosStringLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<HeliosStringLiteralChar> getStringLiteralCharList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, HeliosStringLiteralChar.class);
  }
