...
public class HeliosByteArrayLiteralImpl extends ASTWrapperPsiElement implements HeliosByteArrayLiteral {

  public HeliosByteArrayLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HeliosVisitor visitor) {
    visitor.visitByteArrayLiteral(this);
  }
