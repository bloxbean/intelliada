...
public class HeliosOptionTypeExprImpl extends HeliosValueExprImpl implements HeliosOptionTypeExpr {

  public HeliosOptionTypeExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HeliosVisitor visitor) {
    visitor.visitOptionTypeExpr(this);
  }
