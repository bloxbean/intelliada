...
public class HeliosStringLiteralCharImpl extends ASTWrapperPsiElement implements HeliosStringLiteralChar {

  public HeliosStringLiteralCharImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HeliosVisitor visitor) {
    visitor.visitStringLiteralChar(this);
  }
