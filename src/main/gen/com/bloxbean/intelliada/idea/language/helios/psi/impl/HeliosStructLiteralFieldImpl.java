...
public class HeliosStructLiteralFieldImpl extends ASTWrapperPsiElement implements HeliosStructLiteralField {

  public HeliosStructLiteralFieldImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public HeliosWord getWord() {
    return findChildByClass(HeliosWord.class);
  }
