...
public class HeliosListTypeExprImpl extends HeliosValueExprImpl implements HeliosListTypeExpr {

  public HeliosListTypeExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HeliosVisitor visitor) {
    visitor.visitListTypeExpr(this);
  }
