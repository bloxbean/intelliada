...
public class HeliosSwitchCaseImpl extends ASTWrapperPsiElement implements HeliosSwitchCase {

  public HeliosSwitchCaseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public HeliosIdentifier getIdentifier() {
    return findChildByClass(HeliosIdentifier.class);
  }
