...
public class HeliosValuePathExprImpl extends HeliosValueExprImpl implements HeliosValuePathExpr {

  public HeliosValuePathExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HeliosVisitor visitor) {
    visitor.visitValuePathExpr(this);
  }
