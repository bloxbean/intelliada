...
public class HeliosWordImpl extends ASTWrapperPsiElement implements HeliosWord {

  public HeliosWordImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PsiElement getTWord() {
    return findNotNullChildByType(T_WORD);
  }
