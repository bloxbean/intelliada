...
public class HeliosImportFieldImpl extends ASTWrapperPsiElement implements HeliosImportField {

  public HeliosImportFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HeliosVisitor visitor) {
    visitor.visitImportField(this);
  }
  ...
  @Override
  @NotNull
  public List<HeliosWord> getWordList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, HeliosWord.class);
  }
