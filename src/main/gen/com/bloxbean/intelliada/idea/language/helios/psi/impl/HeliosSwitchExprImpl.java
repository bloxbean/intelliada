...
public class HeliosSwitchExprImpl extends HeliosValueExprImpl implements HeliosSwitchExpr {

  public HeliosSwitchExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<HeliosSwitchCase> getSwitchCaseList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, HeliosSwitchCase.class);
  }

  @Override
  @Nullable
  public HeliosSwitchDefault getSwitchDefault() {
    return findChildByClass(HeliosSwitchDefault.class);
  }
