...
public class HeliosEnumStatementImpl extends ASTWrapperPsiElement implements HeliosEnumStatement {

  public HeliosEnumStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<HeliosEnumMember> getEnumMemberList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, HeliosEnumMember.class);
  }
  ...
  @Override
  @Nullable
  public HeliosImplDefinition getImplDefinition() {
    return findChildByClass(HeliosImplDefinition.class);
  }
