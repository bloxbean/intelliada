...
public class AikenFunctionStatementTypeImpl extends ASTWrapperPsiElement implements AikenFunctionStatementType {

  public AikenFunctionStatementTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AikenVisitor visitor) {
    visitor.visitFunctionStatementType(this);
  }
