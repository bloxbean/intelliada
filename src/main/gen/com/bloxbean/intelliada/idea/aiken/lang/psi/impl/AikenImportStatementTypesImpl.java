...
public class AikenImportStatementTypesImpl extends ASTWrapperPsiElement implements AikenImportStatementTypes {

  public AikenImportStatementTypesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AikenVisitor visitor) {
    visitor.visitImportStatementTypes(this);
  }
