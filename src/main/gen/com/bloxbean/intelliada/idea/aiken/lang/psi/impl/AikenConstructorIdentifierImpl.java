...
public class AikenConstructorIdentifierImpl extends ASTWrapperPsiElement implements AikenConstructorIdentifier {

  public AikenConstructorIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AikenVisitor visitor) {
    visitor.visitConstructorIdentifier(this);
  }
