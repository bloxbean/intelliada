...
public class AikenTypeIdentifierInnerTypeImpl extends ASTWrapperPsiElement implements AikenTypeIdentifierInnerType {

  public AikenTypeIdentifierInnerTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AikenVisitor visitor) {
    visitor.visitTypeIdentifierInnerType(this);
  }
  ...
  public AikenTypeIdentifier getTypeIdentifier() {
    return findNotNullChildByClass(AikenTypeIdentifier.class);
  }
