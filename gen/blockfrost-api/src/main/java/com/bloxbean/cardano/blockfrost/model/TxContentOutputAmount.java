 ...
 */
@ApiModel(description = "The sum of all the UTXO per asset")
@JsonPropertyOrder({
  TxContentOutputAmount.JSON_PROPERTY_UNIT,
  TxContentOutputAmount.JSON_PROPERTY_QUANTITY
})
...
public class TxContentOutputAmount {
  ...
  public TxContentOutputAmount unit(String unit) {
    this.unit = unit;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(value = "The unit of the value")
  ...
  public TxContentOutputAmount quantity(String quantity) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The quantity of the unit")
  ...
  /**
   * Return true if this tx_content_output_amount object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TxContentOutputAmount txContentOutputAmount = (TxContentOutputAmount) o;
    return Objects.equals(this.unit, txContentOutputAmount.unit) &&
        Objects.equals(this.quantity, txContentOutputAmount.quantity);
  }
  ...
  public String toString() {
    ...
    sb.append("class TxContentOutputAmount {\n");
