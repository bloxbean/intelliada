...
@JsonPropertyOrder({
  ...
  InlineResponse200.JSON_PROPERTY_VERSION
})
...
public class InlineResponse200 {
   ...
   * @return url
  **/
  @ApiModelProperty(example = "https://blockfrost.io/", required = true, value = "")
   ...
   * @return version
  **/
  @ApiModelProperty(example = "0.1.0", required = true, value = "")
