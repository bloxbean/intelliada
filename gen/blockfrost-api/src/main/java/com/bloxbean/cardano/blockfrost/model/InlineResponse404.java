 ...
 */
@JsonPropertyOrder({
  InlineResponse404.JSON_PROPERTY_STATUS_CODE,
  InlineResponse404.JSON_PROPERTY_ERROR,
  InlineResponse404.JSON_PROPERTY_MESSAGE
})
...
public class InlineResponse404 {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "The requested component has not been found.", value = "")
