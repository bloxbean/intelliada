 ...
 */
@JsonPropertyOrder({
  InlineResponse500.JSON_PROPERTY_STATUS_CODE,
  InlineResponse500.JSON_PROPERTY_ERROR,
  InlineResponse500.JSON_PROPERTY_MESSAGE
})
...
public class InlineResponse500 {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "An unexpected response was received from the backend.", value = "")
  ...
  /**
   * Return true if this inline_response_500 object is equal to o.
   */
  @Override
