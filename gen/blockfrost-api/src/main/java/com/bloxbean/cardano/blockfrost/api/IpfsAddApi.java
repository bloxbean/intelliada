...
import com.bloxbean.cardano.blockfrost.model.InlineResponse2003;
...
public class IpfsAddApi {
  ...
  public IpfsAddApi(ApiClient apiClient) {
   ...
   */
  public InlineResponse2003 ipfsAddPost() throws ApiException {
    ApiResponse<InlineResponse2003> localVarResponse = ipfsAddPostWithHttpInfo();
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InlineResponse2003> ipfsAddPostWithHttpInfo() throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = ipfsAddPostRequestBuilder();
    try {
      ...
      if (localVarResponse.statusCode()/ 100 != 2) {
        throw new ApiException(localVarResponse.statusCode(),
            "ipfsAddPost call received non-success response",
            localVarResponse.headers(),
            localVarResponse.body() == null ? null : new String(localVarResponse.body().readAllBytes()));
      }
      return new ApiResponse<InlineResponse2003>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<InlineResponse2003>() {})
        );
    } catch (IOException e) {
  ...
  private HttpRequest.Builder ipfsAddPostRequestBuilder() throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/ipfs/add";
