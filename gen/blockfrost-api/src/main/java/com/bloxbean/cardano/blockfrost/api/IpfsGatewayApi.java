...
public class IpfsGatewayApi {
  ...
  public IpfsGatewayApi(ApiClient apiClient) {
   ...
   */
  public void ipfsGatewayIPFSPathGet(String ipFSPath) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> ipfsGatewayIPFSPathGetWithHttpInfo(String ipFSPath) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = ipfsGatewayIPFSPathGetRequestBuilder(ipFSPath);
    try {
      ...
      if (localVarResponse.statusCode()/ 100 != 2) {
        throw new ApiException(localVarResponse.statusCode(),
            "ipfsGatewayIPFSPathGet call received non-success response",
  ...
  private HttpRequest.Builder ipfsGatewayIPFSPathGetRequestBuilder(String ipFSPath) throws ApiException {
    // verify the required parameter 'ipFSPath' is set
    if (ipFSPath == null) {
      throw new ApiException(400, "Missing the required parameter 'ipFSPath' when calling ipfsGatewayIPFSPathGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/ipfs/gateway/{IPFS_path}"
