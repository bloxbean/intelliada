...
[**ipfsAddPostWithHttpInfo**](IpfsAddApi.md#ipfsAddPostWithHttpInfo) | **POST** /ipfs/add | Add a file or directory to IPFS
...
import com.bloxbean.cardano.blockfrost.api.IpfsAddApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        IpfsAddApi apiInstance = new IpfsAddApi(defaultClient);
        try {
            InlineResponse2003 result = apiInstance.ipfsAddPost();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling IpfsAddApi#ipfsAddPost");
...
## ipfsAddPostWithHttpInfo

> ApiResponse<InlineResponse2003> ipfsAddPost ipfsAddPostWithHttpInfo()
...
public class Example {
    public static void main(String[] args) {
        ...
        IpfsAddApi apiInstance = new IpfsAddApi(defaultClient);
        try {
            ApiResponse<InlineResponse2003> response = apiInstance.ipfsAddPostWithHttpInfo();
...
ApiResponse<[**InlineResponse2003**](InlineResponse2003.md)>
